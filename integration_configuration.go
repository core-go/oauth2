...
type IntegrationConfiguration struct {
	...
	Oauth2Link      string `json:"oauth2Link,omitempty" gorm:"column:oauth2link" bson:"oauth2Link,omitempty" dynamodbav:"oauth2Link,omitempty" firestore:"oauth2Link,omitempty"`
