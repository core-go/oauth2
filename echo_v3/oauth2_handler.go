...
func (h *OAuth2Handler) Configuration() echo.HandlerFunc {
...
func (h *OAuth2Handler) Configurations() echo.HandlerFunc {
	return func(ctx echo.Context) error {
...
func (h *OAuth2Handler) Authenticate() echo.HandlerFunc {
	return func(ctx echo.Context) error {
		r := ctx.Request()
