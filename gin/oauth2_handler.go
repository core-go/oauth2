...
func (h *OAuth2Handler) Configuration() gin.HandlerFunc {
...
func (h *OAuth2Handler) Configurations() gin.HandlerFunc {
	return func(ctx *gin.Context) {
...
func (h *OAuth2Handler) Authenticate() gin.HandlerFunc {
	return func(ctx *gin.Context) {
